...
define( 'CDH_FILES_LOCAL_TO_CLOUD_BUCKET_NAME', 'cdh-fileslocaltocloud-' . CDH_DOMINIO_SIN_PUNTO );
...
define('CDH_FILES_LOCAL_LOCALDIR_BACKUP',      "cdhfileslocal");
define('CDH_FILES_LOCAL_LOCALFILE_BACKUP',      "cdhlocalfiles.zip");

define('CDH_FILES_LOCAL_LOCALDIR_BACKUP_URL',  "http://" . CDH_DOMINIO_CON_PUNTO . "/" . CDH_FILES_LOCAL_LOCALDIR_BACKUP . "/" . CDH_FILES_LOCAL_LOCALFILE_BACKUP );
...
#define('CDH_FILES_LOCALDIR_BACKUP',      "store/cdhfileslocal");
