<?php
    ...
    */
    ...
    class CDH_awsDBClusterParameterGroup extends CDH_abstractAwsService {
        ...
        public function __construct(){
            $this->setCredentials();
            $this->setClientRds();
            $this->setClassName("CDH_awsDBClusterParameterGroup");
        }
        ...
        public function create ( $data = [] ) {
            ...
            try{
                ...
                $result     = $client->createDBClusterParameterGroup( $data );
                $service    = $result  ['DBClusterParameterGroup'];
        ...
        public function getServiceByName( $name  ){
            ...
            if( !is_object($result) || !is_array( $result['DBClusterParameterGroups'] )  )
                return false;

            $services = $result['DBClusterParameterGroups'];

            foreach ( $services as $service ){
                #echo PHP_EOL . "\$service = " . $service['Name'] . " | \$name = $name";    
                if( strcmp ($service['DBClusterParameterGroupName'], $name ) == 0 ) 
                    return $service;
        ...
        public function delete( $name ){
            ...
            try{
                ...
                $result = $client->deleteDBClusterParameterGroup([
                    'DBClusterParameterGroupName' => $name, // REQUIRED
                ]);
                return true;
            }catch(AwsException $e){
                $e->getMessage();
